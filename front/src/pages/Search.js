      ...
      <Navbar expand="lg" variant="dark" className="navbar-main">
        <Container fluid>
          ...
          <Nav className="mr-auto">
            ...
            <Nav.Link as={Link} to="/search" className="active-link">
              Search
            </Nav.Link>
      ...
      <div className="container my-5 text-white">
        ...
        <div className="row">
          <div className="col-md-6 mb-5 mb-md-0">
            ...
            <p className="mb-4">
              Upload an image of the missing person to search for.
            </p>
                ...
                <tbody>
                  {data.map((row) => (
                    <tr key={row.ID}>
                      <td>{row.Name}</td>
                      <td>
                        <img src={row.Photo} alt="Missing Report Image" />
                      </td>
                      <td>
                        <Button
                          variant="success"
                          className="ml-auto"
                          onClick={() =>
                            handleApprove(row.ID, row.Name, row.Capture)
                          }
                        >
                          Approve
                        </Button>
